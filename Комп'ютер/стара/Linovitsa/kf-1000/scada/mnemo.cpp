...
Mnemo::Mnemo(IoNetClient &src, QWidget *p) : QLabel(p), m_ui(new Ui::mnemo),s(src)
{
    ...
    connect(m_ui->bnY_14,SIGNAL(clicked()),this,SLOT(slotCallGVodaCtrl()));
    connect(m_ui->bnY_15,SIGNAL(clicked()),this,SLOT(slotCallGVodaCtrl()));
...
void Mnemo::updateDataRaw()
{
    ...
    m_ui->bnY_14->setIcon(QIcon(s[3]->getValue16("Y_14")?QString(":/valves/valve_green_20x32.png"):QString(":/valves/valve_off_20x32.png")));
    m_ui->bnY_15->setIcon(QIcon(s[3]->getValue16("Y_15")?QString(":/valves/valve_green_20x32.png"):QString(":/valves/valve_off_20x32.png")));
...
void Mnemo::slotCallGVodaCtrl()
{
    dlgGVodaCtrl p(*s[3],this);
    p.exec();
