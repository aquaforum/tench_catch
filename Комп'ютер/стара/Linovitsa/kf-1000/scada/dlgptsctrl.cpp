    ...
    ui(new Ui::DlgPtsCtrl)
{
    ...
    ui->offCl_1->setChecked(src.getValue16("offCl_1")!=0);
    ui->offCl_2->setChecked(src.getValue16("offCl_2")!=0);
    ui->offCl_3->setChecked(src.getValue16("offCl_3")!=0);
    connect(ui->offCl_1,SIGNAL(clicked(bool)),this,SLOT(slotOffCl(bool)));
    connect(ui->offCl_2,SIGNAL(clicked(bool)),this,SLOT(slotOffCl(bool)));
    connect(ui->offCl_3,SIGNAL(clicked(bool)),this,SLOT(slotOffCl(bool)));
...
void DlgPtsCtrl::slotOffCl(bool v)
{
