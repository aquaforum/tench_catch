#include "IoUdpClient.h"


#include <QDebug>
#include <QMessageBox>

IoUdpClient::IoUdpClient(QString hostname,int nPort) : host(hostname),Port(nPort),cMode(true)
{
...
void IoUdpClient::changeEvent(QEvent *e)
{
...
void IoUdpClient::slotConnected()
{
    qDebug() << "Conected..";
...
void IoUdpClient::slotTimeout() // таймаут отримання даних від сервера
{
...
void IoUdpClient::slotDisconnect() // від’єднання зі сторони сервера
{
...
void IoUdpClient::slotError(QAbstractSocket::SocketError)
{
...
void IoUdpClient::slotNewConnect()
{
...
void IoUdpClient::slotSendQuery()
{
...
void IoUdpClient::slotReadServer()
{
